  ...
  return (
    <div className={'flex flex-row gap-4  flex-wrap'}>
      ...
      <div className={'flex flex-row basis-full'}>
        <p
          className={
            'font-normal text-lg xl:text-xl 2xl:text-2xl u-text-gray-400 sm:max-w-xl md:max-w-3xl lg:max-w-4xl selectable'
          }
        >
          TikPedia anaylize current trends and create videos using AI. You can
          publish videos to TikTok and YouTube. You can also track your videos
          performance and customize your videos. TikPedia also provides
      ...
      <div className={'flex flex-row basis-full sm:justify-center'}>
        <div
          className={
            'grid md:grid-cols-2 sm:grid-cols-1 lg:grid-cols-3 xl:grid-cols-3 gap-8'
          }
        >
